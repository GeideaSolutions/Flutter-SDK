...
class PaymentCard {
  ...
  Map<String, dynamic>? toMap() {
    Map<String, Object?> expiryDateParams = {};
    expiryDateParams[BaseRequestBody.fieldMonth] = expiryMonth;
    expiryDateParams[BaseRequestBody.fieldYear] = expiryYear;

    Map<String, Object?> paymentMethodParams = {};
    paymentMethodParams[BaseRequestBody.fieldCardNumber] = number;
    paymentMethodParams[BaseRequestBody.fieldCardholderName] = name;
    paymentMethodParams[BaseRequestBody.fieldCvv] = cvc;
    paymentMethodParams[BaseRequestBody.fieldExpiryDate] = expiryDateParams;
