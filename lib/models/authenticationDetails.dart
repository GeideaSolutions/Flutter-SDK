class AuthenticationDetails {
  ...
  String? acsEci, authenticationToken, paResStatus, veResEnrolled, xid, accountAuthenticationValue, proofXml;

  AuthenticationDetails({this.acsEci, this.authenticationToken, this.paResStatus, this.veResEnrolled, this.xid, this.accountAuthenticationValue, this.proofXml});
