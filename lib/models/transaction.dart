...
import 'package:geideapay/models/meezaDetail.dart';
...
class Transaction {
  ...
  Transaction.fromMap(Map<String, dynamic> map) {
    ...
    meezaDetails = map['meezaDetails'] == null
        ? null
        : MeezaDetail.fromJson(map['meezaDetails']);
    ...
    authenticationDetails = map['authenticationDetails'] == null
        ? null
        : AuthenticationDetails.fromMap(map['authenticationDetails']);
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      "meezaDetails": meezaDetails?.toJson(),
