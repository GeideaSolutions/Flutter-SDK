...
class Order {
  ...
  double? amount, tipAmount, convenienceFeeAmount, totalAmount, totalAuthorizedAmount, totalCapturedAmount, totalRefundedAmount;

  String? orderId, currency, language, detailedStatus, status, threeDSecureId, 
  merchantId, merchantPublicKey, parentOrderId, merchantReferenceId, callbackUrl, 
  customerEmail, returnUrl, tokenId, initiatedBy, agreementId, agreementType, paymentOperation, custom,
  paymentMethods, platform, description, customerReferenceId, customerId, recurrence, createdDate, createdBy, updatedDate, updatedBy;

  Address? billingAddress;
  Address? shippingAddress;

  bool? cardOnFile, setDefaultPaymentMethod, restrictPaymentMethods, createCustomer, isTokenPayment;
