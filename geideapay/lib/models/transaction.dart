...
class Transaction {
  ...
  double? amount;
  bool? sameBank;
  String? transactionId, type, status, currency, source, authorizationCode, rrn, postilionDetails, terminalDetails, meezaDetails, bnplDetails, correlationId, createdDate, createdBy, updatedDate, updatedBy;
  PaymentMethod? paymentMethod;
  Codes? codes;
  AuthenticationDetails? authenticationDetails;


  Transaction({this.transactionId, this.type, this.status, this.amount, this.currency, this.source, this.authorizationCode, this.rrn, this.sameBank, this.postilionDetails, this.terminalDetails, this.meezaDetails, this.bnplDetails, this.correlationId, this.createdDate, this.createdBy, this.updatedDate, this.updatedBy, this.paymentMethod, this.codes, this.authenticationDetails});
  ...
  Transaction.fromMap(Map<String, dynamic> map) {
    ...
    authenticationDetails = map['authenticationDetails'] == null ? null : AuthenticationDetails.fromMap(map['authenticationDetails']);
  }
